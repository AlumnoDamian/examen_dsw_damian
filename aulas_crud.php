<?php
    ...
    class AulasCrud extends ProgramaBase
    {
        ...
        function inicializar()
        {
            ...
            $letra       = new Select  ('letra'    ,Aula::LETRA,['validar' => True]);
            $numero      = new Input   ('numero'       ,['placeholder' => 'Número del aula...'     , 'validar' => True ]);
                    ...
                    $listado_aulas .= "
                        <tr>
                            <th scope=\"row\">
                                ...
                                ". enlace("/{$this->seccion}/consultar/{$fila['id']}",'Consultar',['class' => 'btn btn-secondary']) ."
                            </th>
                            <td>{$fila['nombre']}</td>
                            <td>{$fila['letra']}</td>
                            <td>{$fila['numero']}</td>
